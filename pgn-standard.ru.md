...
2) в ней есть только стандартные семь тегов идентификации ростера ("STR", см. [ниже](#811-seven-tag-roster)),
3) в ней нет вариаций рекурсивной аннотации ("RAV", см. [ниже](#825-movetext-rav-recursive-annotation-variation)),
4) в ней нет числовых аннотационных глифов ("NAG", см. [ниже](#10-numeric-annotation-glyphs)).
...
> *** Представление комментариев в формате экспорта требует дополнительного уточнения.
...
> *** Спецификация представления RAV элементов для импорта/экспорта требует дальнейшего развития.
